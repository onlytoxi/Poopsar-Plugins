...
namespace Quasar.Client.Kematian.Browsers.Helpers.SQL
{
    public class SQLiteHandler
    {
        ...
        public bool ReadTable(string TableName)
        {
            ...
            string[] strArray = master_table_entries[index].sql_statement.Substring(master_table_entries[index].sql_statement.IndexOf("(") + 1).Split(new char[] { ',' });
