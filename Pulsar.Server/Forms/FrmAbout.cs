...
namespace Pulsar.Server.Forms
{
    ...
    {
        private readonly string _repositoryUrl = @"https://github.com/Pulsar-Continuation/Pulsar-Modded";
        ...
        private async Task<string> FetchContributors()
        {
            using (WebClient client = new WebClient())
            {
                ...
                string apiUrl = "https://api.github.com/repos/Pulsar-Continuation/Pulsar-Modded/contributors";
